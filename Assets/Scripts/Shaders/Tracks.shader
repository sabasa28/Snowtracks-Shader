Shader "Custom/Tracks"
{
    Properties
    {
        ...
        _SurfaceTex ("Surface (RGB)", 2D) = "white" {}       
    ...
    SubShader
    {
        ...
        #pragma surface surf Standard fullforwardshadows vertex:disp tessellate:tesseDistance
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fixed4 c = lerp(tex2D(_SurfaceTex, IN.uv_SurfaceTex) * _SurfaceColor, tex2D(_GroundTex, IN.uv_GroundTex) * _GroundColor, amount);
